...
See the [Authentication guide](/developers/authentication) for API keys and HMAC signing details, or the [Programmatic API guide](/developers/programmatic-api) for the full partner integration workflow.

## Endpoint Groups

<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/api-reference/auth/create-api-key">
