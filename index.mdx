...
<CardGroup cols={2}>
  <Card title="Start trading" icon="arrow-right" href="https://limitless.exchange">
    Go to limitless.exchange to start trading now.
  </Card>
  <Card title="Join our Discord" icon="discord" href="https://discord.com/invite/yb4SscD8RZ">
    Chat with traders and the Limitless team.
  </Card>
</CardGroup>

<Note>
  Need help? Use the **support channel** in the footer at [limitless.exchange](https://limitless.exchange), or reach out at [hey@limitless.network](mailto:hey@limitless.network).
</Note>
