...
<Frame caption="EOA wallet connection options on Limitless">
  <img src="/images/externally-owned-accounts.png" alt="Login screen showing MetaMask, Rabby Wallet, Coinbase Wallet, and other wallet options" />
</Frame>
...
<Frame caption="Social login options for creating an embedded wallet">
  <img src="/images/embedded-wallets.png" alt="Login screen showing email, Google, Discord, and Farcaster sign-in options" />
</Frame>
...
<Frame caption="Smart wallets are created via social login">
  <img src="/images/externally-owned-accounts.png" alt="Login screen showing wallet and social login options" />
</Frame>
