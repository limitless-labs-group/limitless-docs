...
from limitless.order_client import OrderClient, Side, OrderType
...
<Tabs>
  <Tab title="Standard CLOB">
    ...
    CT_ADDRESS = "0x..."  # Conditional Token framework address
...
```python
from limitless.exceptions import APIError
